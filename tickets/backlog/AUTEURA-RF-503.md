# AUTEURA-RF-503 — Extract ControlZoneRouter
...
## Problem Statement
AppLayout routes monitor, adjust, timeline, pipeline, and settings inline.

## Why This Matters
Routing between control-zone surfaces should be isolated from shell rendering.

## Scope
Extract control-zone routing for the major studio modes.

## Out of Scope
Do not change control-zone content.

## Acceptance Criteria
- [ ] Control-zone routing is isolated.
- [ ] Per-mode content remains unchanged.

## Constraints
Maintain current public behavior unless the ticket explicitly changes it.

## Context / Affected Areas
Control-zone routing.
