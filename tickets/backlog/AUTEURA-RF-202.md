# AUTEURA-RF-202 — Extract VisionFrameScheduler
...
## Problem Statement
Frame pumping, cadence limiting, hidden-tab pause, and bitmap submission are embedded in AIController.

## Why This Matters
Scheduling policy should be isolated from React state publication.

## Scope
Extract frame pump, duplicate suppression, cadence limiting, visibility pause/resume, and bitmap submission flow.

## Out of Scope
Do not change throughput policy without explicit approval.

## Acceptance Criteria
- [ ] Scheduling logic is isolated and testable.
- [ ] Hidden-tab and cadence behavior remain unchanged.

## Constraints
Maintain current public behavior unless the ticket explicitly changes it.

## Context / Affected Areas
AI frame scheduling and visibility behavior.
