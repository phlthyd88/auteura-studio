# AUTEURA-RF-604 — Assign subsystem owners and update release board
...
## Problem Statement
The release board tracks serious work, but ownership discipline needs to be explicit and durable.

## Why This Matters
Clear ownership improves accountability and future maintenance.

## Scope
Assign subsystem owners and update board and process artifacts accordingly.

## Out of Scope
Do not change the meaning of existing release criteria without team agreement.

## Acceptance Criteria
- [ ] Subsystem ownership is explicit.
- [ ] Release board and process artifacts are updated.
- [ ] Future work can be routed cleanly.

## Constraints
Maintain current public behavior unless the ticket explicitly changes it.

## Context / Affected Areas
Subsystem ownership and release process.
