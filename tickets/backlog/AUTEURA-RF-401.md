# AUTEURA-RF-401 — Extract TimelineProjectSession
...
## Problem Statement
TimelineController owns project load/save/select/delete and dirty-state concerns alongside playback and editing logic.

## Why This Matters
Project session management should be isolated for clarity and easier testing.

## Scope
Extract initial load, autosave, refresh/list/select/delete project, and dirty-state coordination into a project session module.

## Out of Scope
Do not redesign project model semantics.

## Acceptance Criteria
- [ ] Timeline project session logic is isolated.
- [ ] Autosave and project switching behavior remain stable.

## Constraints
Maintain current public behavior unless the ticket explicitly changes it.

## Context / Affected Areas
Timeline project session management.
