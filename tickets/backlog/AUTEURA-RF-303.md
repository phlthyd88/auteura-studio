# AUTEURA-RF-303 — Extract TimelapseService
...
## Problem Statement
Timelapse worker timing and hidden-tab behavior are embedded in RecordingController.

## Why This Matters
This behavior is complex enough to warrant its own service boundary.

## Scope
Extract timer worker lifecycle, hidden-tab pause/resume, shot counting, and stop conditions into a timelapse service.

## Out of Scope
Do not fix unrelated timelapse behavioral bugs unless directly implicated.

## Acceptance Criteria
- [ ] Timelapse logic is isolated.
- [ ] Hidden-tab pause/resume semantics remain correct.

## Constraints
Maintain current public behavior unless the ticket explicitly changes it.

## Context / Affected Areas
Timelapse scheduling and hidden-tab handling.
