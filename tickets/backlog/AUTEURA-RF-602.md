# AUTEURA-RF-602 — Normalize service, coordinator, and facade naming
...
## Problem Statement
Inconsistent naming across extracted modules can create confusion for future maintainers.

## Why This Matters
A clear naming convention improves discoverability and comprehension.

## Scope
Normalize naming across runtime services, coordinators, facades, and selectors.

## Out of Scope
Do not churn names without reason.

## Acceptance Criteria
- [ ] Naming is consistent and documented.
- [ ] Subsystem boundaries are easier to read.
