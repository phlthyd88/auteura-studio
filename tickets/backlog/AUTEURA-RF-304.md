# AUTEURA-RF-304 — Extract CapturePresetService
...
## Problem Statement
Capture preset operations are mixed into controller orchestration.

## Why This Matters
Separating preset management improves clarity and testability.

## Scope
Extract preset list/save/delete/apply behavior.

## Out of Scope
Do not broaden into look preset work.

## Acceptance Criteria
- [ ] Capture preset logic is isolated.
