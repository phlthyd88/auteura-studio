# AUTEURA-RF-501 — Extract StudioShell
...
## Problem Statement
AppLayout currently mixes shell frame, responsive drawer behavior, and view composition.

## Why This Matters
Shell structure should be isolated from per-mode logic and telemetry composition.

## Scope
Extract desktop/mobile frame, drawer behavior, and shell surface composition.

## Out of Scope
Do not redesign the shell UX.

## Acceptance Criteria
- [ ] Shell frame is isolated.
...
Shell frame and responsive behavior.
